...
GAME_NAME = 'fortnite'
model_file_path = Path(f'/Users/christiancoenen/Google Drive/Social Media Automation/models/game_detection_{GAME_NAME}.h5')
model = tf.keras.models.load_model(model_file_path)
video_file_path = '/Users/christiancoenen/Google Drive/Social Media Automation/' \
                  'Falsch predicted/predicted as Fortnite/clip_9.mp4'
